  ...
  render() {
    const _this$props = this.props,
      ...
      testID
          ...
          rest = _objectWithoutProperties(_this$props, ["small", "icon", "label", "accessibilityLabel", "color", "disabled", "onPress", "theme", "style", "visible", "loading", "testID"]);
    ...
    return /*#__PURE__*/React.createElement(_Surface.default, _extends({}, rest, {
      ...
      pointerEvents: "none"
    }, icon && loading !== true ? /*#__PURE__*/React.createElement(_CrossFadeIcon.default, {
      source: icon,
      size: 24,
